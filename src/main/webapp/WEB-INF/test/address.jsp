...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>resources/address/style.css">
</head>
<body>
<div>
    <fieldset>
...
<script src="<%=basePath%>resources/address/city.js"></script>
<script src="<%=basePath%>resources/address/city02.js"></script>

<script src="<%=basePath%>resources/address/method01.js"></script>
<script src="<%=basePath%>resources/address/method02.js"></script>
<script src="<%=basePath%>resources/address/method03.js"></script>
</body>
</html>
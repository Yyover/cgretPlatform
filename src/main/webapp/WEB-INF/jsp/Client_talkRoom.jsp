...
<%@ page import="com.javaee6.cgret.util.ClientThreadLocal" %>
...
<script type="text/javascript">
    ...
    // when user come in, the ws should be connected
    var roomName = "shop" + ${wsId};
    var lockReconnect =
    var webSocket;
    ...
    if ("WebSocket" in window) {
        ...
        webSocket.onopen = function () {
            var roomInput = document.getElementById("input_roomName")[0];
            alert("已进入聊天室" + roomName + "，畅聊吧...");
            roomInput.innerHTML(roomName);

...
/**
    ...
    */
/**
     * 通过clientID从repository得到List<client>
     *
     * @param clientId
     * @return
     *//*
    ...
    @Override
    public List<Client> getByClientId(Long clientId) {
...
/**
    ...
    @Override
    public void delete(String indexName, String type, Long clientId) {
